...
internal static class SearchCommand
{
    internal static Command Build()
    {
        ...
        cmd.Add(queryArg); cmd.Add(tagOpt); cmd.Add(propOpt); cmd.Add(limitOpt);
    ...
    private static async Task<int> RunAsync(
        IpcClient client, string? query, string[] tags, string[] properties, int? limit, VaultScope scope)
    {
